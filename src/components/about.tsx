        ...
        <section id="aboutSection" className="about-section">
            ...
            <div className="about-me-intro-container">
                <div className="about-me--intro">
                    ...
                    <p>
                        Hello there! 👋 I'm Kenneth, a passionate second-year college student with a love for web
                        design and coding. I've embarked on a self-taught journey into web development,
                ...
                <div className="about-me--current-endeavors">
            ...
            <div className="my-skills-container">
                <div className="my-skills--language">
                    ...
                    <div className="my-skills--language-container">
                ...
                <div className="my-skills--tools">
                    ...
                    <div className="my-skills--tools-container">
